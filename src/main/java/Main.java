...
public class Main {
    public static void main(String[] args) {
        ...
        JuniorDeveloper juniorDeveloper = new JuniorDeveloper(1, "Esra", 10000);
        JuniorDeveloper juniorDeveloper1 = new JuniorDeveloper(2, "Burcu", 20000);
        System.out.println(juniorDeveloper.toString());
        juniorDeveloper.Work();

        MidDeveloper midDeveloper = new MidDeveloper(1,"Merve",50000);
        System.out.println(midDeveloper.toString());
        midDeveloper.Work();

        SeniorDeveloper seniorDeveloper = new SeniorDeveloper(1,"Özgür",70000);
        System.out.println(seniorDeveloper.toString());
        seniorDeveloper.Work();


        HRManager hrManager = new HRManager(1,"Fatma", 30000,
